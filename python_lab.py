...
representation_dict = {d1 * (base**2) + d2 * (base**1) + d3 * (base**0):(d1,d2,d3) for d1 in digits for d2 in digits for d3 in digits}
...
listdict2dict = {names[i]:id2salary.get(i,0) for i in range(len(names))}
